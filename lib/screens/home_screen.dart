...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ValueNotifier<double> dailyBudget = ValueNotifier(10000000);
  ...
  void getDailyBudget() async {
    String? storedDailyBudget = await storage.read(key: 'dailyBudget');

    setState(() {
      dailyBudget.value = double.parse(storedDailyBudget ?? '0');
    });
  }
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // SizedBox(height: 1.h),
                              Text(
                                  "* Data is based on current month transactions",
                              ...
                              builder: (context, value, child) {
                                return netBalance.todaysExpense > value &&
                                    ...
                                    ? Padding(
                                        ...
                                        child: Text(
                                            "!! You have exceeded your daily budget by ₹ ${netBalance.todaysExpense - value}",
                                            style: TextStyle(
                                                fontSize: 14.sp,
                                                fontWeight: FontWeight.w600,
                                                color: Colors.red)))
